...
int main(){
    ...
    Food total("Total nutrition info: ", 0, 0, 0, 0, 0);
    ...
    do{
        ...
        if(selection == (i + 1)){
            ...
            cout << "\nEnter the ammount of calories: " << endl;
            cin >> calToSet;
            newfood.setCal(calToSet);
        ...
        total.setCal(total_calories);
        total.setFat(total_fat);
        total.setSugar(total_sugar);
        total.setProtein(total_protein);
        total.setSodium(total_sodium);
        
        
    }while (selection != (i + 2));
    
    cout << total.getName() << endl;
    cout << "Total calories for the day: " << total.getCalories() << " calories. " << endl;
    cout << "Total fat for the day: " << total.getFat() << " grams. " << endl;
    cout << "Total sugar for the day: " << total.getSugar() << " grams. " << endl;
    cout << "Total protein for the day: " << total.getProtein() << " grams. " << endl;
    cout << "Total sodium for the day: " << total.getSodium() << " milligrams. " << endl;
